<div class="panel panel-default pull-left highscore-panel">
    ...
    <div class="panel-body panel-body-zd">
        <div class="row highscore-platzierung">
            <div class="pull-left">
                <img src="{{URL::asset('/img/highscore_1.png')}}" alt="1.Platz" class="highscore-medaille">
            </div>
            <div class="pull-left">
                <span class="highscore-name">Sportlicher Seehund</span>
            </div>
            <div class="pull-right">
                <span class="highscore-wert">999999 Wh</span>
            </div>
        </div>
        <div class="row highscore-platzierung">
            <div class="pull-left">
            ...
            <div class="pull-left">
                <span class="highscore-name">Strammer Springbock</span>
            </div>
            <div class="pull-right">
                <span class="highscore-wert">1,0 Wh</span>
            </div>
        </div>
        <div class="row highscore-platzierung">
            <div class="pull-left">
            ...
            <div class="pull-left">
                <span class="highscore-name">Eiliges Erdmännchen</span>
            </div>
            <div class="pull-right">
                <span class="highscore-wert">0,8 Wh</span>
            </div>
        </div>
    </div>
</div>